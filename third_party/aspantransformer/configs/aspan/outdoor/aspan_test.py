import sys
sys.path.append("third_party/aspantransformer/src/config")
...
# cfg.ASPAN.MATCH_COARSE.THR = 0.4 # 0.4 for eth3d triangulation
cfg.ASPAN.MATCH_COARSE.THR = 0.2 # 0.4 for eth3d sfm
